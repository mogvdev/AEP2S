...
### RF07 – Validar informações
O sistema deverá validar informações importantes durante o cadastro e as operações, evitando códigos duplicados, quantidades negativas, campos obrigatórios vazios e opções inválidas.
...
### RNF03 – Privacidade dos dados
O sistema deverá utilizar somente dados fictícios e informações coletivas, sem armazenar dados sensíveis individuais dos estudantes.

### RNF04 – Armazenamento
As informações deverão permanecer armazenadas em memória durante a execução do programa.

### RNF05 – Organização do código
O sistema deverá ser dividido em funções com responsabilidades claras.
